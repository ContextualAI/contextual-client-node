...
describe('resource documents', () => {
  ...
  test('list: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.datastores.documents.list('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
  ...
  test('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.datastores.documents.list(
        '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
        {
          ...
          uploaded_before: '2019-12-27T18:11:19.117Z',
        },
        { path: '/_stainless_unknown_path' },
      ),
    ).rejects.toThrow(ContextualAI.NotFoundError);
  ...
  test('delete', async () => {
    const responsePromise = client.datastores.documents.delete(
      '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test('setMetadata', async () => {
    const responsePromise = client.datastores.documents.setMetadata(
      '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      {},
    );
